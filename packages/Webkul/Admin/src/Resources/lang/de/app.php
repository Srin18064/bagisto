...
return [
    'users' => [
        'sessions' => [
            ...
            'password'               => 'Passwort',
            'powered-by-description' => 'Powered by :wephoton, ein Open-Source-Projekt von :wetech.',
            'submit-btn'             => 'Anmelden',
            'title'                  => 'Anmelden',
        ],
    ...
    'components' => [
        'layouts' => [
            ...
            'powered-by' => [
                'description' => 'Bereitgestellt von :bagisto, ein Open-Source-Projekt von :wetech.',
            ],
        ],
