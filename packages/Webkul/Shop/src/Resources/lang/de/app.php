...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer'               => '© Copyright 2010 - :current_year, Wetech Software (in Indien registriert). Alle Rechte vorbehalten.',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'footer-text'            => '© Copyright 2010 - :current_year, Wetech Software (eingetragen in Indien). Alle Rechte vorbehalten.',
                'locale'                 => 'Sprache',
